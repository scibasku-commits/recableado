...
<script type="application/ld+json">
{
  ...
  "author": {
    ...
    "description": "Viajero de 72 años y empresario desde los años ochenta, documentando la adopción de la Inteligencia Artificial desde la experiencia vivida."
  },
  "publisher": {
    "@type": "Organization",
...
<script type="application/ld+json">
{
  ...
  "description": "Empresario de viajes premium desde los años ochenta reconvertido en explorador digital. Ayudo a la generación 'Silver' a perder el miedo a la tecnología mediante la experimentación práctica y el humor."
}
</script>
{{ end }}
```
