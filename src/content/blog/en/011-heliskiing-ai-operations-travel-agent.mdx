...
Could an algorithm detect that Ignasi's face changes when you mention "helicopter" and "altitude" in the same sentence? Could a machine know that a two-second silence on the call means he's scared but won't say it? I've been reading those silences since the eighties.
