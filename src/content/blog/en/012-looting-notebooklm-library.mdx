...
description: "75 scattered sources turned into 989 lines in 12 minutes. How I looted a digital library with NotebookLM MCP and Claude Code working in parallel."
pubDate: 2026-02-17
tags: ["🔥 Now", "🛠️ Workshop"]
...
<img src="https://res.cloudinary.com/drqgkirpy/image/upload/f_auto,q_auto,w_800/blog/saqueo-notebooklm/infografia-saqueo-biblioteca.png" alt="Infographic: The night my AI and I looted a library of 75 books — 158 notebooks, 10 parallel queries, 75 sources processed in 12 minutes, 1 document of 989 lines" style="width: 100%; max-width: 700px; margin: 2rem auto; display: block; border-radius: 12px;" />
...
At 72, I have something no AI model has: **life context**. I know what information is useful because I've been traveling since the eighties and using AI intensively for 2 years.

Claude processed 75 sources in 12 minutes. It took me decades to know what questions to ask.
...
Travel entrepreneur since the eighties (CICMA 2283). I've been using AI intensively for 2 years to run a boutique travel agency. 14 Skills configured, 3 chatbots deployed, and a blog where I share what I learn without filters.
