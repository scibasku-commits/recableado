...
## The dislocated shoulder: can AI help you manage the unexpected?

Day 5 in Niseko, one of the group members fell on the slope. Dislocated shoulder. Morphine. Transfer to the traumatologist.

When you receive that message at two in the morning Spanish time, the first thing you need is fast and reliable information. Not Google. Not forums. Structured information.

I asked Claude:

*"A traveler in my group in Niseko just dislocated their shoulder. They're being treated. What should the agency do right now? What does travel insurance normally cover in a case like this? What documentation will I need for the claim?"*

In two minutes I had:

1. A five-step action protocol
2. A list of documents the traveler should request from the Japanese doctor
3. The standard coverage clauses in travel insurance for skiing accidents
4. A draft communication to send the traveler with clear instructions

I didn't follow every recommendation to the letter — I have forty years of experience in this and I use my own judgment — but having that framework in two minutes, at two in the morning, is worth a great deal.

**What I learned:** AI doesn't replace judgment. But when you're alone with your phone at two in the morning and you need to think clearly, having an assistant that structures the problem is extraordinarily valuable.
...
I asked Claude for the emergency phone number for the provider (Jonview) and the standard resolution protocol. In less than three minutes I had the number, the WhatsApp customer service contact, and the industry's standard solution.

I called. I got through on the third attempt. The solution: the group would buy a one-day pass directly at the window, and I would reimburse them. Jonview would send the correct passes for the next day.
