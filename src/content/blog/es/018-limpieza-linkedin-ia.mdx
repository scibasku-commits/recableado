...
<div style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: center; margin: 2rem 0;">
  <img src="/infografias/018-linkedin-cleanup-1.png" alt="Infografía: Cómo la IA resolvió un caos de 4 perfiles de LinkedIn en 30 minutos — El protagonista, el problema y la solución paso a paso" style="max-width: 48%; min-width: 280px; border-radius: 12px;" />
  <img src="/infografias/018-linkedin-cleanup-2.png" alt="Infografía: IA sin Edad — Cómo un profesional de 72 años resolvió 4 perfiles de LinkedIn en 30 minutos. Cronología de la resolución." style="max-width: 48%; min-width: 280px; border-radius: 12px;" />
</div>
