...
## Aprendiz de la calle desde los años ochenta
...
Vendiendo viajes desde los años ochenta. Décadas de aprendizaje continuo sin un solo pupitre.
...
Y yo les digo: llevo vendiendo viajes desde los años ochenta, empecé con una máquina de escribir, pasé al fax, luego al email, luego a un CRM, luego a cinco IAs trabajando para mí mientras duermo. Y lo único que ha cambiado es que ahora *me gusta aprender*.
